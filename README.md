...
See [CONTRIBUTING.md](https://github.com/ScientaNL/DoctrineJsonFunctions/blob/master/CONTRIBUTING.md) for how to run the test suites, how the function nodes are layered, and how to add a function or a platform.

Domain terms are defined in [CONTEXT.md](https://github.com/ScientaNL/DoctrineJsonFunctions/blob/master/CONTEXT.md).

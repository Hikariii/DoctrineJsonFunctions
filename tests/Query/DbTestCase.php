...
class DbTestCase extends \PHPUnit_Framework_TestCase
{
	...
	public function setUp($connParams = array())
	{
		...
		if (empty($connParams)) {
			$connParams = array('driver' => 'pdo_sqlite', 'memory' => true );
		}
		$this->entityManager = EntityManager::create($connParams, $this->configuration);
	}
